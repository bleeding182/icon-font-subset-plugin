...
group = "com.davidmedenjak.compose.glyphs"
version = "1.0.0-SNAPSHOT"

android {
    namespace = "com.davidmedenjak.compose.glyphs"
    compileSdk = 36
    ...
    publishing {
        publications {
            create<MavenPublication>("release") {
                ...
                groupId = "com.davidmedenjak.compose.glyphs"
                artifactId = "compose-glyphs"
                version = project.version.toString()

                pom {
                    name.set("Compose Glyphs")
